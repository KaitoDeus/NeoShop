...
class OrderServiceTest {
    ...
    void createOrder_InsufficientStock() {
        ...
        // Act & Assert
        Exception exception = assertThrows(RuntimeException.class, () -> orderService.createOrder(userId, request));
    ...
    void updateOrderStatus_AssignsKeysWhenPaid() {
        ...
        order.getItems().add(com.neoshop.model.entity.OrderItem.builder()
        ...
        ProductKey mockKey = ProductKey.builder()
                .keyCode("ABC-123")
                .product(sampleProduct)
