...
const SLIDES = [
  {
    ...
    subtitle:
      "Kết nối internet tốc độ cao tại hơn 200 quốc gia. Không cần tháo lắp SIM.",
  ...
  },
  {
    ...
    subtitle:
      "Truy cập GPT-4, tạo hình ảnh AI chất lượng cao. Kích hoạt tức thì.",
  ...
  const categories = [
    {
      icon: <FiMonitor />,
      label: "Giải trí",
      link: "/category?category=giai-tri",
    },
    {
      icon: <FiBriefcase />,
      label: "Làm việc",
      link: "/category?category=lam-viec",
    },
    {
      icon: <FiBookOpen />,
      label: "Học tập",
      link: "/category?category=hoc-tap",
    },
    {
      icon: <FiGlobe />,
      label: "eSIM du lịch",
      link: "/category?category=esim-du-lich",
    },
    {
      icon: <FiVideo />,
      label: "Edit Ảnh - Video",
      link: "/category?category=edit-anh-video",
    },
    {
      icon: <FiLayout />,
      label: "Windows, Office",
      link: "/category?category=windows-office",
    },
    {
      icon: <FiHardDrive />,
      label: "Google Drive",
      link: "/category?category=google-drive",
    },
    {
      icon: <FiCpu />,
      label: "Thế giới AI",
      link: "/category?category=the-gioi-ai",
    },
    {
      icon: <FiShield />,
      label: "VPN, bảo mật",
      link: "/category?category=vpn-bao-mat",
    },
    {
      icon: <FiGift />,
      label: "Gift Card",
      link: "/category?category=gift-card",
    },
  ];
    ...
    <section className="hero-section">
      <div className="container">
        ...
        <div className="promo-grid">
          ...
          <Link
            to="/category?type=design"
            className="promo-box"
            style={{ background: "#991b1b" }}
          >
            <div>
              <h4 className="promo-title">THIẾT KẾ</h4>
              <span className="promo-sub" style={{ color: "#fecaca" }}>
                Adobe / Canva
              </span>
          ...
          <Link
            to="/category?category=entertainment"
            className="promo-box"
          ...
          <Link
            to="/category?category=office"
            className="promo-box"
            style={{ background: "#9a3412" }}
          >
            <div>
              <h4 className="promo-title">OFFICE</h4>
              <span className="promo-sub" style={{ color: "#fed7aa" }}>
                Key Bản quyền
              </span>
