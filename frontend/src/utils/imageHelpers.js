...
export const getProductCover = (title) => {
    ...
    if (lowerTitle.includes('microsoft 365') || lowerTitle.includes('office')) return officeImg;
    ...
    if (lowerTitle.includes('god of war') || lowerTitle.includes('gow')) return gowImg;
    ...
    if (lowerTitle.includes('github') || lowerTitle.includes('copilot')) return copilotImg;
    if (lowerTitle.includes('playstation') || lowerTitle.includes('ps plus')) return psPlusImg;
    if (lowerTitle.includes('adobe') || lowerTitle.includes('creative cloud')) return adobeImg;
