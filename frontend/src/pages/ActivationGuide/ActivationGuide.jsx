      ...
      <div className="container">
        ...
        <div className="guide-header">
          <div className="header-content">
            <h1>
              <FiKey /> Hướng dẫn kích hoạt sản phẩm
            </h1>
            <p>
        ...
        <div className="notes-box">
          ...
          <ul>
            <li>
              Mỗi key chỉ có thể kích hoạt <strong>một lần duy nhất</strong>.
            </li>
            <li>Đảm bảo bạn đã đăng nhập đúng tài khoản muốn kích hoạt.</li>
            <li>
              Không chia sẻ key với người khác để tránh mất quyền sử dụng.
            </li>
            <li>
              Liên hệ CSKH ngay nếu key không hoạt động trong vòng 24 giờ.
            </li>
          </ul>
        </div>
        ...
        <div className="platforms-section">
          <h2>
            <FiMonitor /> Chọn nền tảng của bạn
          </h2>
        ...
        <div className="troubleshoot-section">
          <h2>
            <FiHelpCircle /> Gặp vấn đề khi kích hoạt?
          </h2>
          ...
          <div className="troubleshoot-grid">
            <div className="trouble-card">
              ...
              <p>
                Kiểm tra lại key, đảm bảo không có khoảng trắng thừa. Thử sao
                chép lại từ email gốc.
              </p>
            </div>
            <div className="trouble-card">
              ...
              <p>
                Liên hệ CSKH ngay với ảnh chụp màn hình lỗi và mã đơn hàng để
                được hỗ trợ.
              </p>
            </div>
            <div className="trouble-card">
              ...
              <p>
                Kiểm tra thư mục Spam. Nếu không có, liên hệ CSKH với email đã
                dùng để đặt hàng.
              </p>
            </div>
          </div>
