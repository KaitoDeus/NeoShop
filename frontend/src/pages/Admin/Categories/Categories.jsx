...
const Categories = () => {
  ...
  const handleDelete = async (id) => {
    if (
      window.confirm(
        "Bạn có chắc chắn muốn xóa danh mục này? Hãy chắc chắn rằng không còn sản phẩm nào thuộc danh mục này.",
      )
    ) {
      try {
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Quản lý các nhóm sản phẩm kỹ thuật số của hệ thống.
          </p>
        </div>
            ...
            {loading ? (
              ...
              filteredCategories.map((cat) => (
                <tr key={cat.id}>
                  ...
                  <td>
                    <span
                      className={`badge ${cat.parentId ? "badge-info" : "badge-light"}`}
                    >
