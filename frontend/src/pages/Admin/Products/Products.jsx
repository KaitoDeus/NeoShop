      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Quản lý danh sách sản phẩm và kho key số của hệ thống
          </p>
        </div>
            ...
            {loading ? (
              ...
              products.map((product) => (
                <tr key={product.id}>
                  ...
                  <td>
                    <span
                      className={`status-badge ${product.status === "ACTIVE" || product.status === "active" ? "status-active" : "status-hidden"}`}
                    >
        ...
        <div className="table-footer">
          <div className="table-info">
            ...
            <span className="font-bold">
              {products.length > 0 ? page * 10 + 1 : 0}
            </span>{" "}
            đến{" "}
            <span className="font-bold">
              {Math.min((page + 1) * 10, totalElements)}
            </span>{" "}
            trong <span className="font-bold">{totalElements}</span> kết quả
          </div>
