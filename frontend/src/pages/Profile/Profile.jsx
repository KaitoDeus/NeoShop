...
const Profile = () => {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: "error",
        text: "Đổi mật khẩu thất bại. Kiểm tra lại mật khẩu cũ.",
      });
    }
  };
  ...
  const handleAvatarUpload = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Tải ảnh lên thành công! Nhấn Lưu để cập nhật hồ sơ.",
      });
    } catch (error) {
            ...
            <div className="tab-content fade-in">
              ...
              {loadingOrders ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Hãy khám phá các sản phẩm tuyệt vời của chúng tôi và đặt
                    hàng ngay hôm nay!
                  </p>
                  <button
                    onClick={() => navigate("/")}
                  ...
                  <div className="form-group avatar-section">
                    ...
                    <div className="avatar-input-wrapper">
                      ...
                      >
                        {profileData.avatar ? (
                          <img
                            src={getAvatar(profileData.avatar)}
                            alt="Preview"
                          />
                        ) : (
                          <FiUser />
