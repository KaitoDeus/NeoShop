          ...
          features: [
            {
              ...
              desc: "Hỗ trợ kỹ thuật và bảo hành suốt đời.",
            },
            {
              icon: <FiCheckCircle />,
              title: "Chính hãng",
              desc: "Sản phẩm bản quyền 100% từ nhà phát hành.",
            },
          ],
        };
          ...
          <div className="pd-main-content">
            ...
            <div className="pd-meta-bar">
              <div className="rating-box">
                <div className="stars">
                  <FiStar fill="#facc15" /> <FiStar fill="#facc15" />{" "}
                  <FiStar fill="#facc15" /> <FiStar fill="#facc15" />{" "}
                  <FiStar fill="#facc15" />
                </div>
                <span>
            ...
            <div className="pd-section">
              ...
              <div className="desc-content">
                <p>
                  Sở hữu <strong>{product.name}</strong> bản quyền với mức giá
                  ưu đãi nhất thị trường. Bạn sẽ nhận được:
                </p>
                <ul>
                  <li>
                    <strong>Tiết kiệm chi phí:</strong> So với giá gốc mua trực
                    tiếp từ nhà phát hành.
                  </li>
                  <li>
                    <strong>An toàn tuyệt đối:</strong> Key/Tài khoản sạch,
                    nguồn gốc rõ ràng, nói không với hàng lậu.
                  </li>
                  <li>
                    <strong>Hỗ trợ tận tình:</strong> Đội ngũ NeoShop luôn sẵn
                    sàng hỗ trợ cài đặt và kích hoạt.
                  </li>
                  <li>
                    <strong>Bảo hành trọn đời:</strong> Yên tâm sử dụng với
                    chính sách bảo hành 1 đổi 1.
                  </li>
                </ul>
                <p>
                  Sản phẩm phù hợp cho game thủ, người làm việc chuyên nghiệp
                  muốn sở hữu bản quyền chính hãng giá tốt.
                </p>
              </div>
            </div>
              ...
              <div className="steps-list">
                <div className="step-item">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Ngay sau khi thanh toán, hệ thống sẽ gửi mã kích hoạt/chi
                      tiết tài khoản qua email của bạn.
                    </p>
                  </div>
                </div>
                <div className="step-item">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Sử dụng mã key để kích hoạt trên nền tảng tương ứng
                      (Steam, Epic, Adobe, Microsoft...).
                    </p>
                  </div>
                </div>
                <div className="step-item">
                  ...
                  <div className="step-content">
                    <h4>Hoàn tất</h4>
                    <p>
                      Sau khi kích hoạt thành công, sản phẩm sẽ được lưu vĩnh
                      viễn trong tài khoản của bạn.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      setReviewError("");
                      try {
                        const res = await productService.createReview(id, {
                          rating,
                          comment,
                        });
                        ...
                        setReviewError(
                          e.response?.data?.message ||
                            "Đã xảy ra lỗi hoặc bạn đã đánh giá rồi.",
                        );
                      } finally {
                          ...
                          >
                            {[1, 2, 3, 4, 5].map((star) => (
                              <FiStar
                                ...
                                color={r.rating >= star ? "#facc15" : "#cbd5e1"}
                                size={14}
                              />
                            ))}
                            <span
          ...
          <div className="buy-box">
            ...
            <div className="price-section">
              ...
              <div className="original-price">
                {formatUSDtoVND(product.originalPrice)}
              </div>
              <div
                style={{
                  fontSize: "0.85rem",
